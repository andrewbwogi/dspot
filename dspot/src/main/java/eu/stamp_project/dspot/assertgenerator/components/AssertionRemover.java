...
public class AssertionRemover {
    ...
    public List<CtLocalVariable<?>> removeAssertion(CtInvocation<?> invocation) {
        ...
        if (!(invocation.getMetadata(Utils.METADATA_ASSERT_AMPLIFICATION) != null &&
                (boolean) invocation.getMetadata(Utils.METADATA_ASSERT_AMPLIFICATION))) {
            for (CtExpression<?> argument : invocation.getArguments()) {
                ...
                if (clone instanceof CtLambda) {
                    ...
                    clone.putMetadata(Utils.METADATA_WAS_IN_ASSERTION, true);
                    ...
                    localVariable.putMetadata(Utils.METADATA_WAS_IN_ASSERTION, true);
        ...
        CtStatement topStatement = Utils.getTopStatement(invocation);
